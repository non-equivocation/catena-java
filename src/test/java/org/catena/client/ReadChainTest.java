...
public class ReadChainTest extends ClientServerTest
{
    ...
    {
        log.info("Test: Read statements with client launched beforehand");
    ...
    {
        log.info("Test: Read statements with client launched after issued statements");
    ...
    public void testRestartReuseWallet() throws InsufficientMoneyException, IOException, InterruptedException {
        ...
        log.info("Test: Read statements across client restarts (reusing old wallet)");
    ...
    public void testRestartNewWallet() throws InsufficientMoneyException, IOException, InterruptedException {
        ...
        log.info("Test: Read statements across client restarts (using new wallet)");
